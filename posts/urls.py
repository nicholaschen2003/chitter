...
urlpatterns = [
    ...
    path('userAuthentication/<next>/', views.userAuthentication, name='userAuthentication'),
    ...
    path('posts/<twitterHandle>/<int:post_id>/<int:basePost_id>/<currentPage>/like/', views.like, name='like'),
]
